...
}(function ($) 
{
	...
	DateTimePicker.prototype = {
		...
		_createPicker: function()
		{
			...
			{
				console.log("_hidePicker _createPicker");
				oDTP._hidePicker("");
			});
		...
		showDateTimePicker: function(oElement)
		{
			...
			{
				console.log("_hidePicker showDateTimePicker");
		...
		_addEventHandlersForPicker: function()
		{
			...
			{
				console.log("_hidePicker click.DateTimePicker");
				oDTP._hidePicker("");
			});
			...
			$(document).on("keydown.DateTimePicker", function(e)
			{
				if(! $('.dtpicker-compValue').is(':focus') && parseInt(e.keyCode ? e.keyCode : e.which) !== 9)
				{
					console.log("_hidePicker keydown.DateTimePicker");
					oDTP._hidePicker("");
				}
			});
